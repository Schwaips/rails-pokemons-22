...
ash.avatar.attach(io: URI.parse('https://upload.wikimedia.org/wikipedia/en/e/e4/Ash_Ketchum_Journeys.png').open, filename: 'ash_ketchum.png', content_type: 'image/png')
puts "Ash has stepped up to the plate!"
misty = Trainer.create(name: "Misty", age: 20)
misty.avatar.attach(io: URI.parse('https://upload.wikimedia.org/wikipedia/en/b/b1/MistyEP.png').open, filename: 'misty.png', content_type: 'image/png')
puts "Misty is ready to go!"
brock = Trainer.create(name: "Brock", age: 22)
brock.avatar.attach(io: URI.parse('https://upload.wikimedia.org/wikipedia/en/7/71/DP-Brock.png').open, filename: 'brock.png', content_type: 'image/png')
